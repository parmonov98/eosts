...
;(function($) {
	...
	$.datePicker = {
		strings: {
			...
			monthsShort: ['Yan', 'Feb', 'Mar', 'Apr', 'May', 'Iyun', 'Iyul', 'Avg', 'Sen', 'Okt', 'Noy', 'Dek'],
			daysFull: ['Dushanba', 'Seshanba', 'Chorshanba', 'Payshanba', 'Juma', 'Shanba', 'Yanshanba'],
			daysShort: ['Du', 'Se', 'Ch', 'Pa', 'Ju', 'Sh', 'Yak'],
